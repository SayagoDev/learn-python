...
if __name__ == '__main__':
    ...
    tamano_morral = 50
    n = len(valores)
    mensaje = 'Calculo del problema del morral de forma recursiva'

    resultado = morral(tamano_morral, pesos, valores, n, mensaje)

    print(f'\n * El metodo se llamo {contador} veces para calcular {n} elementos')
    print(f'El valor maximo que podemos robar es: {resultado}')
    print(f'La complejidad del algoritmo es O(nW) donde n es el numero de elementos y W el tamaño del morral')